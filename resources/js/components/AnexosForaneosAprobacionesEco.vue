    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Aprobaciones Foraneas Eco
            ...
            <div class="card-body">
                <div class="form-group row">
                 ...
                 <button class="btn btn-warning btn_sm float-right" type="button" @click="listarIngresob('0','0','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Pendiente
                 </button>

                    <button class="btn btn-info btn_sm float-right" type="button" @click="listarIngresob ('1','1','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Aprobaciones
                 </button>
                 <button class="btn btn-light btn_sm float-right" type="button" @click="listarIngresob ('1','2','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Aprobaciones final
                 </button>
                 <button class="btn btn-danger btn_sm float-right" type="button" @click="listarIngresob ('1','3','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Autorizado en Proceso
                 </button>
                 <button class="btn btn-secondary btn_sm float-right" type="button" @click="listarIngresob ('1','4','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Por facturar
                 </button>
                 <button class="btn btn-success btn_sm float-right" type="button" @click="listarIngresob ('1','5','anexosforaneos.status','','','')">
...
methods : {
    ...
    listarIngreso(page,buscar,criterio, contra, fecha_inicio,fecha_final){
        ...
        let me=this;
        var url= 'ordenesForaneas?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final + '&eco_id=1';
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    cambiarPagina(page,buscar,criterio){
        ...
        this.listarIngreso(page,this.buscar,this.criterio, '','','');
    },
    listarIngresob(page,buscar,criterio, contra, fecha_inicio,fecha_final){
    this.buscar = buscar; 
    this.criterio = criterio ;
    this.listarIngreso(page,buscar,criterio, contra, fecha_inicio, fecha_final);
    },
    ...
    pdfdescargar(cotizacion){
          let me=this;
        var url= 'ordenesForaneas/factura?id='+cotizacion.id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    buscarConceptops(pagina,page,buscar,titulo){
        let me=this;
        var url= 'afconceptos/selectConceptos?page=' + pagina +'&idc=' + page + '&idt='+ buscar  + "&buscar="+titulo;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    verReporteAnomalias(id){
        let me=this;
        var url= 'ordenesForaneas/verReporteAnomalias?id=' + id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
     ...
     verFotosNuevas(id){
        let me=this;
        var url= 'ordenesForaneas/verFotosNuevas?id=' + id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
    ...
    verFotosInstaladas(id){
        let me=this;
        var url= 'ordenesForaneas/verFotosInstaladas?id=' + id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
     ...
     verAcuse(id){
        let me=this;
        var url= 'ordenesForaneas/verAcuse?id=' + id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
     ...
     verFacturaXML(id){
        let me=this;
        var url= 'ordenesForaneas/verFacturaXML?id=' + id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
    ...
    verFacturaPDF(id){
        let me=this;
        var url= 'ordenesForaneas/verFacturaPDF?id=' + id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
      ...
      verFotosViejas(id){
        let me=this;
        var url= 'ordenesForaneas/verFotosViejas?id=' + id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
   ...
   verOrdenServicio(id){
        let me=this;
        var url= 'ordenesForaneas/verOrdenServicio?id=' + id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
    ...
    pdfCotizacionp(id){
        window.open('ordenesForaneas/pdfCFE/'+ id,'_blank');
    },
    mostrarDetalle(){
        let me=this;
        me.listado=0;
    ...
    actualizarcarrito(detalle){
     let me = this;
        ...
        axios.post('detalleCarritoAF/actualizar',{
            'id': detalle.id,
            'cantidad': detalle.cantidad,
