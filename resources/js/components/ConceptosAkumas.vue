    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Conceptos Akumas
...
methods : {
    listarCategoria (page,buscar,criterio,categoria_id,tipo_id){
        let me=this;
        var url= 'conceptosAkumas?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio  + '&categoria_id='+ categoria_id+ '&tipo_id='+ tipo_id;
    ...
    actualizarCategoria(){
        ...
        axios.put('conceptosAkumas/actualizar',{
    ...
    desactivarCategoria(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.post('conceptosAkumas/desactivar',{
                'id': id
            }).then(function (response) {
                me.listarCategoria(1,'','nombre');
                swal(
