    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Facturación por contrato
...
methods : {
    listarFacturas (page,buscar,criterio, contra){
        let me=this;
        var url= 'facturacionPorContrato?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra;
    ...
    buscarContrato(contrato){
                ...
                this.listarFacturas(1,this.buscar ,this.criterio, '1');
            },
