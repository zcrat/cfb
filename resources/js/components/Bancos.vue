                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Nombre del banco">
    ...
    export default {
        ...
        methods : {
            ...
            validarCategoria(){
                ...
                if (!this.nombre) this.errorMostrarMsjCategoria.push("El nombre del banco no puede estar vacío.");
