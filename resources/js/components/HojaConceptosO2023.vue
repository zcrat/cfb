      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <i class="fa fa-align-justify mr-2"></i> Hoja de Conceptos Occidente 2023
...
<div class="modal-body">
 <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody class="tbody" v-if="arrayConceptos.length">
                    ...
                    <ul class="pagination">
                        <li class="page-item" v-if="pagination2.current_page > 1">
                            <a class="page-link" href="#" @click.prevent="cambiarPaginaConceptos(pagination2.current_page - 1,categorias_id,tipos_id)">Ant</a>
                        </li>
  ...
  export default {
    ...
    methods: {
      ...
      guardarOrdenCompra(){
                let me = this;
                axios
                    .post('ordenCompra3',{datos:me.ordenCompra,conceptos:me.conceptosarray})
                    .then(function(response){
                        console.log(response.data);
                        me.$toastr.success('Se guardo correctamente la orden de compra', 'Orden de compra');
                        me.registrarRecepcion = 2;
    ...
    llenado (p){
      ...
      conceptos(ordenSeguimiento){
        ...
        let me = this;
        axios
          .get('conceptos3/'+ordenSeguimiento)
          .then(function(response){
            console.log(response);
    ...
    axios.post('conceptosO2023/registrar',{
      ...
      eliminarConcepto(numConcepto, id){
        ...
        if(this.update == true && id != undefined){
          let me = this;
          axios
            .delete('concepto3/'+numConcepto+'/'+id)
            .then(function(response){
              console.log(response.data);
      ...
      listarHojaConcepto() {
        let me = this;
        axios
          .get("hojaConceptos/index?modulo=3")
          .then(function(response) {
            console.log(response);
      ...
      buscarConceptops(pagina,page,buscar){
        let me=this;
        var url= 'conceptosO2023/selectConceptos?page=' + pagina +'&idc=' + page + '&idt='+ buscar;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    guardarTipo(){
      ...
      reporte(id) {
        window.open("hojaConcepto3/reporte/" + id, "_blank");
      },
