...
methods : {
    ...
    reporte(id){
     ...
     subirarchivo9(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('ordenesNew/subirarchivos9',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
    ...
    guardarEntrada(){
        ...
        axios.post('ordenesNew/guardarEntrada',{
    ...
    listarIngreso (page,buscar,criterio, contra){
        let me=this;
        var url= 'ordenesNew/start?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    buscarConceptops(page,buscar){
        let me=this;
        var url= 'conceptos2023/selectConceptos?idc=' + page + '&idt='+ buscar;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
