...
methods : {
    ...
    listarIngreso (page,buscar,criterio, contra, fecha_inicio,fecha_final){
        ...
        let me=this;
        var url= 'ordenesNew?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final + '&contrato='+ this.contrato + '&eco_id=1';
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
