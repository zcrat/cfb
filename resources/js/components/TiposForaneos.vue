    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Tipos Akumas
...
methods : {
    listarCategoria (page,buscar,criterio){
        let me=this;
        var url= 'tiposForaneos?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
    ...
    registrarCategoria(){
        ...
        axios.post('tiposForaneos/registrar',{
            'nombre': this.nombre
    ...
    actualizarCategoria(){
       if (this.validarCategoria()){
        ...
        axios.put('tiposForaneos/actualizar',{
            'nombre': this.nombre,
    ...
    desactivarCategoria(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.post('tiposForaneos/desactivar',{
                'id': id
            }).then(function (response) {
                me.listarCategoria(1,'','nombre');
                swal(
    ...
    activarCategoria(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.put('tiposForaneos/activar',{
                'id': id
            }).then(function (response) {
                me.listarCategoria(1,'','nombre');
                swal(
