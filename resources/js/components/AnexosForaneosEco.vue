    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Anexos Foraneos Eco
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                                ...
                                <button class="btn btn-warning btn_sm float-right" type="button" @click="listarIngreso('0','0','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Pendiente
                 </button>

                    <button class="btn btn-info btn_sm float-right" type="button" @click="listarIngreso('1','1','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Aprobaciones
                 </button>
                 <button class="btn btn-light btn_sm float-right" type="button" @click="listarIngreso('1','2','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Aprobaciones final
                 </button>
                 <button class="btn btn-danger btn_sm float-right" type="button" @click="listarIngreso('1','3','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Autorizado en Proceso
                 </button>
                 <button class="btn btn-secondary btn_sm float-right" type="button" @click="listarIngreso('1','4','anexosforaneos.status','','','')">
                        <i class="fa fa-plus-circle mr-2"></i>Por facturar
                 </button>
                 <button class="btn btn-success btn_sm float-right" type="button" @click="listarIngreso('1','5','anexosforaneos.status','','','')">
