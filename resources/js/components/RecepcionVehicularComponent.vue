                            ...
                            <div class="col-12 col-md-6 offset-md-3">
                                <div class="text-center">
                                    <div class="input-group">
                                        <input type="text" v-model="buscar" @keyup.enter="listarRecepciones(buscar)"
                                               class="form-control" placeholder="Buscar...">
                                        <button type="submit" @click="listarRecepciones(buscar)"
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" v-model="modeloRecepcion.trabajadorq" placeholder="000xx">
                                </div>
                            </div>
                                    </div>
                                </div>
                                <div class="my-4">
                                    <div class="col-12 text-right p-3">
                                        ...
                                        <button class="btn btn-secondary" @click="vistaRecepcionRegistrar"><i
                                                class="fa fa-times mr-2"></i>Canclear
                                        </button>
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            listarRecepciones(orden) {
                let me = this;
                axios.get('recepcion/index?orden='+orden).then(function (response) {
                    console.log(response.data);
