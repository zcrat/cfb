...
methods : {
    ...
    guardarCategoria(){
        let me=this;
         axios.post('ordenesB2023/categoria',{
    ...
    listarIngreso (page,buscar,criterio,fecha_inicio,fecha_final){
        let me=this;
        var url= 'ordenesB2023?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    listarCategorias (){
        let me=this;
        var url= 'ordenesB2023/selectCategorias';
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
            me.arrayCategorias = respuesta.categorias;
    ...
    buscarConceptops(page,buscar,titulo,page1){
        let me=this;
        var url= 'conceptosB2023/selectConceptos?page=' + page1 + '&idc=' + page + '&idt='+ buscar + "&buscar="+titulo;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    listarTipos (){
        let me=this;
        var url= 'ordenesB2023/selectTipos';
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
            me.arrayTipos = respuesta.tipos;
    ...
    agregarConcepto(array){
        ...
        axios.post('conceptosB2023/registrar',{
