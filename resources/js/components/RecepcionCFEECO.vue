        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify mr-2"></i> Recepción Vehícular Eco
                                ...
                                <div class="my-4">
                                    ...
                                    <div class="my-4">
                                        ...
                                        <div class="row border" v-if="registrarVehiculo && !registrarMarca && !registrarModelo && !registrarColor">
                                            ...
                                            <div class="col-12 col-lg-4">
                                                <div class="form-group">
                                                    <label for="vim-id">VIM<i class="fa fa-asterisk ml-2" aria-hidden="true"></i></label>
    ...
    export default {
        ...
        methods: {
            ...
            save(formData) {
                ...
                axios.post('recpecionCFEECO/subir',formData ,
                    {
                    headers: {
            ...
            descargar(cotizacion){
                        window.open('recpecionCFEECO/download/'+ cotizacion,'_blank');
                    },
            ...
            listarArchivos(id){
                let me=this;
                var url= 'recepcionCFEECO/archivos?page=1' + '&buscar='+ id ;
            ...
            uploadFile: function(){
                ...
                axios.post('recepcionCFEECO/subir', formData,
                    {
                    headers: {
                    "Content-Type": "multipart/form-data"
                    }
            ...
            axios
                ...
                me.modeloPresupuesto.ubicacion = respuestaArray.usuario;
            ...
            listarRecepciones(page,orden) {
                let me = this;
                axios.get('recepcion/index?page='+page+'&orden='+orden+'&modulo=6').then(function (response) {
                    console.log(response.data);
            ...
            deleter(id){
                swal({
                    ...
                    if (result.value) {
                        ...
                        axios.put('recepcionCFEECO/delete',{
                            'id': id
                        }).then(function (response) {
                            me.listarRecepciones(1,'');
                            swal(
