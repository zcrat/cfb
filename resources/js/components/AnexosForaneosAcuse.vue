    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Recepcion Vehicular Acuses Foraneos
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" v-model="con_id">
                                    <option value="0">Arrendadora</option>
                                    <option value="1">Occidente</option>
                                    <option value="2">Bajio</option>
                                    </select>
...
methods : {
    ...
    listarIngreso (page,buscar,criterio, contra){
        let me=this;
        var url= 'anexosFRA?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&eco_id=0';
        axios.get(url).then(function (response) {
