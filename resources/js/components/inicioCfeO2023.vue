    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Start Orden
...
methods : {
    ...
    listarIngreso (page,buscar,criterio){
        let me=this;
        var url= 'ordenesO2023?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    buscarConceptops(page,buscar,page1){
        let me=this;
        var url= 'conceptosO2023/selectConceptos?page=' + page1 + '&idc=' + page + '&idt='+ buscar;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
