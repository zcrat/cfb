                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                             ...
                             <div class="col-md-12 float-right">
                                <div class="input-group">
                                    <button type="submit" @click="facturar()" class="btn btn-warning"><i class="icon-doc"></i> Facturar</button>
                                   
                                    <button type="submit" @click="facturaAlmacen()" class="btn btn-primary"><i class="icon-doc"></i> Facturas</button>
                                    <button class="btn btn-info btn_sm float-right" type="button" @click="listarIngreso ('1','1','presupuestosCFE.status','','')">
                                    <i class="fa fa-plus-circle mr-2"></i>Aprobacion
                                    </button>
                                    <button class="btn btn-success btn_sm float-right" type="button" @click="listarIngreso ('1','2','presupuestosCFE.status','','')">
                                            <i class="fa fa-plus-circle mr-2"></i>Aprobacion final
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <tr v-for="cotizacion in arrayCotizacion" :key="cotizacion.id">
                                        ...
                                        <td>
                                            ...
                                            AUTORIZAR
                                              ...
                                              <template v-if="cotizacion.status == 2">
                                             <button type="button" class="btn btn-primary btn-sm" title="Boton de autorizacion">
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="cotizacion in arrayAlmacen" :key="cotizacion.id">
                                        ...
                                        <td>
                                             <button type="button" @click="borrar(cotizacion)" class="btn btn-danger btn-sm">
                                            <i class="icon-ban"></i>
                                            </button>&nbsp;
    ...
    export default {
            ...
            calcularTotalf: function(){
             ...
             calcularTotalfc: function(){
                ...
                for(var i=0;i<this.detallefacturaCompleta.length;i++){
                    resultado=resultado+(this.detallefacturaCompleta[i].importep)
                }
                return resultado;
            },
        ...
        methods : {
            ...
            listarIngreso (page,buscar,criterio, contra ,fecha_inicio,fecha_final){
                ...
                let me=this;
                var url= 'ordenesAll?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
