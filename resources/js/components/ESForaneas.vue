    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                    <i class="fa fa-plus-circle mr-2"></i>Entradas y Salidas Foraneas
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="entrada in arrayEntradasSalidas" :key="entrada.id">
                                    ...
                                    <td v-text="entrada.plaza"></td>
                                    <td v-text="entrada.asignado"></td>
...
methods : {
    listarEntradasSalidas (page,buscar, criterio, from, to){
        let me=this;
        var url= 'eysf?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio +'&from='+ from + '&to='+ to;
    ...
    editarEntradaSalida(entrada){
        ...
        me.modeloEntradaSalida.orden_servicio = entrada.plaza;
    ...
    actualizarEntardaySalida(){
        ...
        axios.put('eysf/actualizar',this.modeloEntradaSalida).then(function (response) {
            console.log(response.data);
            me.cerrarModalEntradasSalidas();
            me.listarEntradasSalidas(1,'','nombre','','');
