    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Conceptos Foraneos
...
methods : {
    listarCategoria (page,buscar,criterio,categoria_id,tipo_id){
        let me=this;
        var url= 'afconceptos?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio  + '&categoria_id='+ categoria_id+ '&tipo_id='+ tipo_id;
    ...
    actualizarCategoria(){
        ...
        axios.put('afconceptos/actualizar',{
