<template>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify mr-2"></i> Tecnicos 
          ...
          <div class="row">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>{{ procesotext(persona.id).then(value => {return value})}}</h3>
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="alumno in arrayPersona2" :key="alumno.id">
                                    ...
                                    <td bgcolor="green" v-text="alumno.marca_modelo"></td>
                                    <td bgcolor="green" v-text="alumno.economico_placas"></td>
                                    <td bgcolor="green" v-text="alumno.r_r"></td>
                                    <td bgcolor="green" v-text="alumno.descripcion"></td>
    ...
    <template v-if="modalTarea == 2">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group row">
                                    <label for="plantel" class="col-md-3 form-control-label">Reasignar Tecnico  <i class="fa fa-asterisk ml-2" aria-hidden="true"></i></label>
                                    <div class="col-md-9">
                                       <select class="form-control" v-model="tecnico_id" >
                                                        <option value="0" disabled>Seleccione su tecnico</option>
...
<div class="form-group row">
    <label class="col-md-3 form-control-label" for="text-input">Marca/Modelo (*)</label>
    <div class="col-md-9">
...
<div class="form-group row">
    <label class="col-md-3 form-control-label" for="text-input">R.R. (*)</label>
    <div class="col-md-9">
...
<div class="form-group row">
    <label class="col-md-3 form-control-label" for="text-input">Reparaciones Realizadas (*)</label>
    <div class="col-md-9">
        <textarea v-model="descripcionTarea" cols="5" rows="3" class="form-control"  placeholder="Descripcion de la tarea"></textarea>
...
<div class="form-group row">
    <label class="col-md-3 form-control-label" for="text-input">Trasladista</label>
    <div class="col-md-3">
        <select class="form-control" v-model="trasladista_id" >
                                                        <option value="0" disabled>Seleccione su trasladista</option>
                                                        <option v-for="plantel in arrayTrasladistas" :key="plantel.id" :value="plantel.id" v-text="plantel.nombre"></option>
        </select>
    </div>
...
<div class="row">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarPersona()" :disabled="disablebutton">Guardar</button>
...
methods : {
    eliminarArchivo(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.put('tecnicos/archivos/eliminar',{
                'id': id
    ...
    reset() {
      ...
      save(formData) {
        ...
        axios.post('tecnicos/subir',formData ,
            {
            headers: {
      ...
      cargarTrasladista(page,buscar,criterio){
        let me=this;
        var url= 'trasladistas?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
        axios.get(url).then(function (response) {
           
            var respuesta= response.data;
            me.arrayTrasladistas= respuesta.personas.data;
    ...
    listarPersona2 (page,id,from,to, criterio, buscar){
        let me=this;
        var url= 'tac/public/tecnicos/reparaciones/?page=' + page + '&id='+ id + '&from='+ from + '&to='+ to + '&criterio='+ criterio + '&buscar='+ buscar ;
        axios.get(url).then(function (response) {
    ...
    async procesotext(id) {
     var promise = require('promise');
     var url= 'tecnicos/reparaciones/?page=' + '1' + '&id='+ id + '&from='+ this.from + '&to='+ this.to;
     return new promise((resolve, reject) => { 
				axios.get(url) 
					.then((res) => resolve(res.data.proceso)) 
    ...
    subirarchivo2(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('tecnicos/subirarchivos',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
    ...
    guardarOrden(){
        ...
        axios.post('tecnicos/guardarOrden',{
            'id': me.tareas_id,
            'archivo': me.archivo
        }).then(function (response) {
    ...
    listarArchivos (id){
        console.log(id)
        let me=this;
        var url= 'tecnicos/archivos?page=1' + '&buscar='+ id;
        axios.get(url).then(function (response) {
    ...
    registrarPersona(){
        ...
        axios.post('tecnicos/reparaciones/registrar',{
            ...
            'trasladista_id': this.trasladista_id,
            'rr' : this.rr,
            'marca' : this.marca,
            'status': this.status,
    ...
    actualizarPersona(){
        ...
        axios.put('tecnicos/reparaciones/actualizar',{
            'id': this.tareas_id,
...
this.modal3=0;
    ...
    verOrden(){
        let me=this;
        var url= 'tecnicos/verOrden?id=' + me.tareas_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
    ...
    deleteReparacion(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.put('tecnicos/reparaciones/delete',{
                'id': id
            }).then(function (response) {
                me.listarPersona2(1,me.user_id,'','');
                swal(
...
mounted() {
    ...
    this.cargarTrasladista(1,this.buscar,this.criterio);
    this.reset();
