            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Start Akumas
    ...
    export default {
        ...
        methods : {
            ...
            reporte(id){
             ...
             subirarchivo9(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes2/subirarchivos9',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
            ...
            guardarEntrada(){
                ...
                axios.post('ordenes2/guardarEntrada',{
            ...
            listarIngreso (page,buscar,criterio, contra){
                let me=this;
                var url= 'ordenes2/start?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
            ...
            buscarConceptops(page,buscar){
                let me=this;
                var url= 'conceptos2/selectConceptos?idc=' + page + '&idt='+ buscar;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
