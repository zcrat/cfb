            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Presupuestos Akumas
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                ...
                                <button class="btn btn-info btn_sm float-right" type="button" @click="listarIngreso ('1','1','presupuestos.status','','')">
                                        <i class="fa fa-plus-circle mr-2"></i>Aprobaciones
                                </button>
                                <button class="btn btn-light btn_sm float-right" type="button" @click="listarIngreso ('1','2','presupuestos.status','','')">
                                        <i class="fa fa-plus-circle mr-2"></i>Aprobaciones final
                                </button>
                                <button class="btn btn-danger btn_sm float-right" type="button" @click="listarIngreso ('1','3','presupuestos.status','','')">
                                        <i class="fa fa-plus-circle mr-2"></i>Autorizado en Proceso
                                </button>
                                <button class="btn btn-secondary btn_sm float-right" type="button" @click="listarIngreso ('1','4','presupuestos.status','','')">
                                        <i class="fa fa-plus-circle mr-2"></i>Por facturar
                                </button>
                                <button class="btn btn-success btn_sm float-right" type="button" @click="listarIngreso ('1','5','presupuestos.status','','')">
                                    ...
                                    <tr v-for="cotizacion in arrayCotizacion" :key="cotizacion.id">
                                        <td>
                                             ...
                                             <select name="LeaveType" @change="onChange($event,cotizacion)" class="form-control">
                                                ...
                                                <option value="6">Presupuesto Acuse</option>
    ...
    export default {
        ...
        methods : {
            ...
            reporte(id){
             ...
             verReporteAnomalias(){
                let me=this;
                var url= 'ordenes2/verReporteAnomalias?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             verFotosNuevas(){
                let me=this;
                var url= 'ordenes2/verFotosNuevas?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            verFotosInstaladas(){
                let me=this;
                var url= 'ordenes2/verFotosInstaladas?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             verAcuse(){
                let me=this;
                var url= 'ordenes2/verAcuse?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             verFacturaXML(){
                let me=this;
                var url= 'ordenes2/verFacturaXML?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            verFacturaPDF(){
                let me=this;
                var url= 'ordenes2/verFacturaPDF?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            listarIngreso (page,buscar,criterio, contra, fecha_inicio,fecha_final){
                ...
                let me=this;
                var url= 'ordenes2?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
             ...
             verFotosViejas(){
                let me=this;
                var url= 'ordenes2/verFotosViejas?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             subirarchivo(e){
                ...
                fileReader.readAsDataURL(e.target.files[0])
                fileReader.onload = (e) => {
                      axios.post('ordenes2/subirarchivos',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
            ...
            subirarchivo2(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes2/subirarchivos2',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo3(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes2/subirarchivos3',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo4(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes2/subirarchivos4',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo5(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes2/subirarchivos5',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo6(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes2/subirarchivos6',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo7(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes2/subirarchivos7',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            detallesConceptos(page){
                let me=this;
                var url= 'detalleconceptos2?id=' + page;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
            ...
            listarCategorias (){
                let me=this;
                var url= 'ordenes2/selectCategorias';
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
                    me.arrayCategorias = respuesta.categorias;
            ...
            checkChoose: function() {
             ...
             agregarDetalles(){
                ...
                me.detalleConceptos = [];
                 ...
                 var url= 'conceptos2/obtenerDetallesmulti';
            ...
            buscarConceptops(pagina,page,buscar,titulo){
                let me=this;
                var url= 'conceptos2/selectConceptos?page=' + pagina +'&idc=' + page + '&idt='+ buscar + "&buscar="+titulo;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
           ...
           llenado (p){
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                me.listarIngreso(page,me.buscar,me.criterio, '','');
            },
            ...
            eliminarDetalle(id){
             ...
             borrar(id){
                let me=this;
                var url= 'detalleconceptos2/delete?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    me.detallesConceptos(me.idpresupuesto);
                })
            ...
            agregarConceptos(detalle){
                ...
                axios.post('detalleconceptos2/registrar',{
            ...
            cambiostatus(id , status){
                let me = this;
                axios.post('ordenes2/cambioStatus',{
                    'id': id,
                    'status': status
                }).then(function (response) {
                    console.log(response.data);
            ...
            guardarFotosviejas(){
                ...
                axios.post('ordenes2/guardarFotoVieja',{
            ...
            guardarReporteAnomalias(){
                ...
                axios.post('ordenes2/guardarReporteAnomalias',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarFotosNuevas(){
                ...
                axios.post('ordenes2/guardarFotoNueva',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarFotosInstaladas(){
                ...
                axios.post('ordenes2/guardarFotoInstalada',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarAcuse(){
                ...
                axios.post('ordenes2/guardarAcuse',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarFacturaXML(){
                ...
                axios.post('ordenes2/guardarFacturaXML',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarFacturaPDF(){
                ...
                axios.post('ordenes2/guardarFacturaPDF',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            agregarConcepto(array){
                ...
                axios.post('conceptos2/registrar',{
            ...
            pdfCotizacion(id){
                window.open('ordenes2/pdf/'+ id,'_blank');
            },
            pdfCotizacionAcuse(id){
                window.open('ordenes2/pdfAcuse/'+ id,'_blank');
            },
            mostrarDetalle(){
                let me=this;
                me.listado=0;
                    ...
                    case "cotizacion":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                                ...
                                this.area = data['ares'];
                                this.idempresa =  data['empresa_id'];
                                this.zonauno = 0;
