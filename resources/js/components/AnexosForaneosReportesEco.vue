    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Reportes Foraneos Eco
            </div>
            <!-- Listado-->
            ...
            <div class="card-body">
                <div class="form-group row">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-2">
                        <div class="input-group">
                            <select class="form-control" v-model="criterio1">
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            <button type="submit" @click="listarVenta(1,buscar,criterio,criterio1,fecha_inicio, fecha_final)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                        </div>
                    </div>

                    <div class="col-md-2">
                        <div class="input-group">
                            <button type="submit" @click="verexel(1,buscar,criterio,criterio1,fecha_inicio, fecha_final)" class="btn btn-success"><i class="icon-doc"></i> Exportar</button>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="venta in arrayVenta" :key="venta.id">
                                <td>
                                    <input type="checkbox"  v-model="check" :value="venta.id" @click.stop="checkChoose()">
                                </td>
                                <td v-text="venta.id"></td>
                                <td v-text="venta.created_at"></td>
                                <td v-text="venta.num_guia"></td>
                                <td v-text="venta.servicio"></td>
                                <td v-text="venta.total"></td>
                                <td v-text="venta.forma_pago"></td>
                                <td v-text="venta.factura"></td>
                                <td v-text="venta.facturado"></td>
                            </tr>   
...
methods : {
    ...
    listarVenta (page,buscar,criterio,criterio1, finicio, ffinal){
        let me=this;
        var url= 'venta?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&criterio1='+ criterio1 + '&finicio='+ finicio + '&ffinal='+ ffinal;
        axios.get(url).then(function (response) {
            console.log(response.data);
    ...
    verexel(page,buscar,criterio,criterio1, finicio, ffinal){
        let me=this;
        window.open('envios/envio?'+"criterio1="+criterio1+"&criterio="+criterio+"&finicio="+finicio+"&ffinal="+ffinal,'_blank');
    },
