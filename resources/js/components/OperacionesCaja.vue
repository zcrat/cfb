            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Operaciones Caja
                       ...
                       <template v-if="caja==1">
                        <button type="button" class="btn btn-secondary float-right" @click="cerrarModal()">Cerrar</button>
                       </template>
                    </div>
                    <div class="card-body">
                        <template v-if="caja==0">
                            ...
                            <tbody>
                                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                    ...
                                    <td v-text="categoria.saldo"> </td>
                                     <td>
                                        <button @click="abrirModalFacturas(categoria.id)" type="button" class="btn btn-warning btn-sm">
...
const STATUS_INITIAL = 0, STATUS_SAVING = 1, STATUS_SUCCESS = 2, STATUS_FAILED = 3;
    export default {
      ...
      save(formData) {
        ...
        axios.post('caja/subir',formData ,
            {
            headers: {
      ...
      listarArchivos (id){
        console.log(id)
        let me=this;
        var url= 'caja/archivos?page=1' + '&buscar='+ id;
      ...
      listarCategoria (page,buscar,criterio){
                let me=this;
                var url= 'caja?page=' + page + '&finicio='+ buscar + '&ffinal='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    console.log(respuesta);
    ...
    descargar(cotizacion){
                 window.open('caja/download/'+ cotizacion,'_blank');
    },
    subirarchivoxml(e){
                let me = this;
