                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                   ...
                                   <button type="button" class="btn btn-info btn-sm" title="Recepcion Vehicular" >
                                            <i class="fa fa-file-invoice"></i>
                                            </button>
                                            <button type="button" class="btn btn-warning btn-sm" title="Fotos Viejas">
                                            <i class="fa fa-picture-o"></i>
                                            </button>
                                            <button type="button" class="btn btn-primary btn-sm" title="Presupuesto Costos">
                                            <i class="fa fa-file-invoice"></i>
                                            </button>
                                             <button type="button" class="btn btn-secondary btn-sm" title="Reporte Anomalias">
                                            <i class="fa fa-file-invoice"></i>
                                            </button>
                                            <button type="button" class="btn btn-light btn-sm" title="Fotos Nuevas">
                                            <i class="fa fa-picture-o"></i>
                                            </button>
                                            <button type="button" class="btn btn-dark btn-sm" title="Fotos Instaladas">
                                            <i class="fa fa-picture-o"></i>
                                            </button>
                                        </td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <button  type="button" class="btn btn-warning" data-toggle="modal" data-target=".bd-example-modal-lg"  > <i class="icon-plus"></i>&nbsp;AGREGAR</button>
                                  <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter2" > <i class="icon-plus"></i>&nbsp;CONCEPTOS</button>
...
<!-- Modal -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
                                       <div class="modal-header">
                                         <h5 class="modal-title" id="exampleModalLongTitle">Catalogo de conceptos</h5>
                                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                           <span aria-hidden="true">&times;</span>
                                         </button>
                                       </div>
...
<table class="table table-bordered table-striped table-sm" id="tabla">
    ...
    <tbody>
        ...
        <tr >
            <td></td>
            <td><input name="intcantidad" type="text" id="intcantidad" value="" size="1" class="form-control" /><input type="hidden" name="MM_update" value="form2" /><input type="hidden" name="idcarrito" value="" /></td>
            <td></td>
            <td></td>
            <td></td>
            <td>
            <a href="javascript:actualizar($('#intcantidad').val(),'')"><button  type='button' class='btn btn-success'> &nbsp;Actualizar</button></a>
            <a href="javascript:preguntar('eliminar_pCFEConcepto51.php?idcon=&id=')"><button  type='button' class='btn btn-danger'> &nbsp;Eliminar</button></a></td>
...
<br />
                        ...
                        <table class="table table-bordered table-striped table-sm" id="tabla">
                            ...
                            <tbody>
                                <tr >
                                    <td>  <textarea name="descripcionMO" id="" cols="30" rows="4" class="form-control" required></textarea></td>
                                   
                                    <td><input type="text" name="importe" value="" id="total" class="form-control" required ></td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                <label for="totalp" style="padding:2ch; background-color:#666; color:#fff">SUBTOTAL: <div id="subtotal"></div> </label>
...
<div class="form-group">
    ...
    <div class="col-md-3">
        <div class="form-group">
        <label for="totalp" style="padding:2ch; background-color:#666; color:#fff">IVA: <div id="iva"></div></label>
...
<div class="form-group">
    ...
    <div class="col-md-3">
        <div class="form-group">
        <label for="totalp" style="padding:2ch; background-color:#666; color:#fff">TOTAL: <div id="grantotal"></div> </label>
    ...
    export default {
        ...
        methods : {
            ...
            llenado (p){
                let me = this;
                console.log(p);
                me.arrayProducto.codigo_sat = p.codigosat;
                me.arrayProducto.unidad_sat = p.unidadsat;
            ...
            agregarConcepto(array){
                ...
                axios.post('conceptos/registrar',{
                    ...
                    'codigo_unidad': array.codigo_unidad,
                    'unidad_text': array.unidad_text,
