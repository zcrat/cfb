      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <i class="fa fa-align-justify mr-2"></i> Hoja de Conceptos Bajio 2023
  ...
  export default {
    ...
    axios.post('conceptosB2023/registrar',{
      ...
      listarHojaConcepto() {
        let me = this;
        axios
          .get("hojaConceptos/index?modulo=2")
          .then(function(response) {
            console.log(response);
      ...
      buscarConceptops(pagina,page,buscar){
        let me=this;
        var url= 'conceptosB2023/selectConceptos?page=' + pagina +'&idc=' + page + '&idt='+ buscar;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
