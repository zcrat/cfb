                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="cotizacion in arrayCotizacion" :key="cotizacion.id">
                                        ...
                                        <td v-text="cotizacion.strodes"></td>
                                        <td v-text="cotizacion.economico"></td>
                                        <td v-text="cotizacion.strid"></td>
                                        <td v-text="cotizacion.placas"></td>
                                        <td v-text="cotizacion.vin"></td>
                                        <td v-text="cotizacion.fecha"></td>
                                        <td v-text="cotizacion.status"></td>
                                        <td v-text="cotizacion.tecnico_id"></td>
                                    </tr>                                
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                            <td>
                                                <button @click="eliminarDetalle(detalle.id)" type="button" class="btn btn-danger btn-sm">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarIngreso()">Registrar Cotizacion</button>
                                <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarIngreso()">Actualizar Cotizacion</button>
    ...
    export default {
        ...
        methods : {
            ...
            registrarIngreso(){
                ...
                axios.post('cotizacion3/registrar',{
                    ...
                    case "cotizacion":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                                //console.log(data);
                                this.listado=0;
                                this.tituloModal='Editar Cotización';
                                this.tipoAccion=2;
                                this.fecha=data['fecha'];
                                this.id_text=data['strid'];
                                this.odes=data['strodes'];
                                this.ejecutivo=data['strejecutivo'];
                                this.n_economico=data['economico'];
                                this.vehiculo=data['vehiculo'];
                                this.vim=data['vin'];
                                this.placas=data['placas'];
                                this.ubicacion= data['strubicacion'];
                                this.km_odometro = data['kmo'];
                                this.tiempo_entrega = data['tentrega'];
                                this.observaciones = data['observa'];
