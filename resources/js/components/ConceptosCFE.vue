    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Conceptos CFE
...
methods : {
    listarCategoria (page,buscar,criterio,categoria_id,tipo_id){
        let me=this;
        var url= 'conceptosCFE?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&categoria_id='+ categoria_id+ '&tipo_id='+ tipo_id;
    ...
    actualizarCategoria(){
        ...
        axios.put('conceptosCFE/actualizar',{
    ...
    desactivarCategoria(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.post('conceptosCFE/desactivar',{
                'id': id
            }).then(function (response) {
                me.listarCategoria(1,'','nombre');
                swal(
            ...
            case "categoria":
            {
                switch(accion){
                    ...
                    case 'actualizar':
                    {
                        ...
                        this.arrayProducto.categorias_id=data['pCFECategorias_id'];
                        this.arrayProducto.tipos_id = data['pCFETipos_id'];
