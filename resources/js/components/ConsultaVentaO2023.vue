...
methods : {
    ...
    listarVenta (page,buscar,criterios,servicio,tipo_servicio,tipo_correctivo,ubi,criterio,criterio1, finicio, ffinal){
        let me=this;
        var url= 'ordenesCFEBuscarO2023?page=' + page + '&buscar='+ buscar + '&criterios='+ criterios + '&servicio='+ servicio + '&tipo_servicio='+ tipo_servicio + '&tipo_correctivo='+ tipo_correctivo + '&ubi='+ ubi + '&criterio='+ criterio + '&criterio1='+ criterio1 + '&finicio='+ finicio + '&ffinal='+ ffinal;
        axios.get(url).then(function (response) {
            console.log(response.data);
    ...
    verexel(page,buscar,criterios,servicio,tipo_servicio,tipo_correctivo,ubi,criterio,criterio1, finicio, ffinal){
        let me=this;
        window.open('ordenesCFExelO2023?buscar='+ buscar + '&criterios='+ criterios + '&servicio='+ servicio + '&tipo_servicio='+ tipo_servicio + '&tipo_correctivo='+ tipo_correctivo + '&ubi='+ ubi + '&criterio='+ criterio + '&criterio1='+ criterio1 + '&finicio='+ finicio + '&ffinal='+ ffinal,'_blank');
    },
