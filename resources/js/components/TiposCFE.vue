    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Tipos CFE
...
methods : {
    listarCategoria (page,buscar,criterio){
        let me=this;
        var url= 'tiposCFE?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
    ...
    desactivarCategoria(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.post('tiposCFE/desactivar',{
                'id': id
            }).then(function (response) {
                me.listarCategoria(1,'','nombre');
                swal(
