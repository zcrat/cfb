    ...
    export default {
        ...
        methods : {
            ...
            listarVenta (page,buscar,criterios,servicio,tipo_servicio,tipo_correctivo,ubi,criterio,criterio1, finicio, ffinal){
                let me=this;
                var url= 'ordenesCFEBuscar?page=' + page + '&buscar='+ buscar + '&criterios='+ criterios + '&servicio='+ servicio + '&tipo_servicio='+ tipo_servicio + '&tipo_correctivo='+ tipo_correctivo + '&ubi='+ ubi + '&criterio='+ criterio + '&criterio1='+ criterio1 + '&finicio='+ finicio + '&ffinal='+ ffinal;
                axios.get(url).then(function (response) {
                    console.log(response.data);
            ...
            verexel(page,buscar,criterios,servicio,tipo_servicio,tipo_correctivo,ubi,criterio,criterio1, finicio, ffinal){
                let me=this;
                window.open('ordenesCFExel?buscar='+ buscar + '&criterios='+ criterios + '&servicio='+ servicio + '&tipo_servicio='+ tipo_servicio + '&tipo_correctivo='+ tipo_correctivo + '&ubi='+ ubi + '&criterio='+ criterio + '&criterio1='+ criterio1 + '&finicio='+ finicio + '&ffinal='+ ffinal,'_blank');
            },
