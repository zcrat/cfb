    ...
    export default {
        ...
        methods: {
            ...
            descargar(cotizacion){
                        window.open('recepcionO2023/download/'+ cotizacion,'_blank');
                    },
            ...
            listarRecepciones(page,orden) {
                let me = this;
                axios.get('recepcion/index?page='+page+'&orden='+orden+'&modulo=3').then(function (response) {
                    console.log(response.data);
