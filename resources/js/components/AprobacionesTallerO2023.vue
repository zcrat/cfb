                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="cotizacion in arrayAlmacen" :key="cotizacion.id">
                                ...
                                <td>
                                     <button type="button" @click="borrarF(cotizacion.id)" class="btn btn-danger btn-sm">
                                    <i class="icon-ban"></i>
                                    </button>&nbsp;
...
methods : {
    ...
    verexel(page,buscar,criterio, contra, fecha_inicio,fecha_final){
        let me=this;
        window.open('ordenesO2023/exel?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final+ '&contrato='+ this.contrato,'_blank');
    },
    ...
    listarIngreso (page,buscar,criterio, contra, fecha_inicio,fecha_final){
        ...
        let me=this;
        var url= 'ordenesAllO2023?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final+ '&contrato='+ this.contrato;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
