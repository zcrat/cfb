    ...
    export default {
        ...
        methods: {
            ...
            axios
                ...
                modeloPresupuesto.clienteYRazonSocial = respuestaArray.administrador;
                modeloPresupuesto.Mail = respuestaArray.jefedeprocesos;
                modeloPresupuesto.Telefono = respuestaArray.telefonojefe;
                modeloPresupuesto.Conductor = respuestaArray.trabajador;
            ...
            listarRecepciones(page,orden) {
                let me = this;
                axios.get('recepcion/index?page='+page+'&orden='+orden+'&modulo=2').then(function (response) {
                    console.log(response.data);
