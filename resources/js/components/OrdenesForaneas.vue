    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                    <i class="fa fa-plus-circle mr-2"></i>Ordenes Foraneas
                    <button class="btn btn-warning btn_sm float-right" type="button" @click="listarordenespagos(1,'','','','')">
     ...
     <template v-if="modalTarea == 0">
            ...
            <div class="col-lg-3 col-6">
                <!-- small box -->
                <div @click="listarordenespagos(1,'status',0,'','')" class="small-box bg-danger">
                <div class="inner">
            ...
            <div class="col-lg-3 col-6">
                <!-- small box -->
                <div @click="listarordenespagos(1,'status',1,'','')" class="small-box bg-warning">
                <div class="inner">
            ...
            <div class="col-lg-3 col-6">
                <!-- small box -->
                <div @click="listarordenespagos(1,'status',2,'','')" class="small-box bg-success">
                <div class="inner">
                ...
                <div class="row">
                             ...
                             <div class="col-md-4">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      ...
                                      <option value="folio_sistema">Plaza</option>
                                      <option value="presupuesto">Mecanico</option>
                                    </select>
                    ...
                    <div class="col-md-12 ">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="entrada in arrayOrdenesForaneas" :key="entrada.id">
...
<div class="form-group row">
    <label class="col-md-3 form-control-label" for="text-input">Plaza</label>
    <div class="col-md-9">
...
<div class="form-group row">
    <label class="col-md-3 form-control-label" for="text-input">Mecanico</label>
    <div class="col-md-9">
...
methods : {
    listarordenespagos (page,criterio,buscar, from, to){
        let me=this;
        var url= 'ordenesf?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio +'&from='+ from + '&to='+ to;
        axios.get(url).then(function (response) {
           
            var respuesta= response.data;
            console.log(respuesta);
           
            me.arrayOrdenesForaneas = respuesta.ordenesforaneas.data;
    ...
    actualizarEntardaySalida(){
        ...
        axios.put('ordenesf/actualizar',this.modeloEntradaSalida).then(function (response) {
            console.log(response.data);
            me.cerrarModalordenespagos();
            me.listarordenespagos(1,'','','','');
