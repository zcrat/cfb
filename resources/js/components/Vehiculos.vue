<template>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify mr-2"></i> Vehiculos 
                        ...
                        <div class="row">
                            <div v-for="persona in arrayPersona" :key="persona.id" class="col-md-3 ">
                                    ...
                                    <blockquote class="blockquote text-center">
                                        ...
                                        <img :src="'img/carrot.png'" class="rounded-circle" width="120" alt="" @click="trasportistas(persona)">
                                    <p class="mb-0">{{ persona.placas}} / {{ persona.economico }}</p>
                                    <a href="#" @click="abrirModal(persona)"><footer class="blockquote-footer"> <cite title="Source Title">Editar</cite></footer></a> 
                                    </blockquote>
         ...
         <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    <button type="submit" @click="listarPersona2(1,user_id,from, to)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                    <div class="col-md-12 ">
                        <div class="form-group row">
    ...
    <template v-if="modalTarea == 2">
        <div class="card">
                <div class="card-header">
                    <i class="fa fa-plus-circle mr-2"></i>Tareas vehiculos
        ...
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group row">
                                    <label for="plantel" class="col-md-3 form-control-label">Trasladistas  <i class="fa fa-asterisk ml-2" aria-hidden="true"></i></label>
                                    <div class="col-md-9">
                                       <select class="form-control" v-model="vehiculo_id" >
                                                        <option value="0" disabled>Seleccione su trasladista</option>
                                                        <option v-for="plantel in arrayVehiculos" :key="plantel.id" :value="plantel.id" v-text="plantel.nombre"></option>
                                                 </select>
                                    </div>
          </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input v-model="placas" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Serie (*)</label>
                                    <div class="col-md-9">
                                        <input v-model="serie" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
...
methods : {
    eliminarArchivo(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.put('vehiculos/archivos/eliminar',{
                'id': id
    ...
    reset() {
      ...
      save(formData) {
        ...
        axios.post('vehiculos/subir',formData ,
            {
            headers: {
    ...
    listarPersona2 (page,id,from,to){
        let me=this;
        var url= 'vehiculos/reparaciones/?page=' + page + '&id='+ id + '&from='+ from + '&to='+ to;
        axios.get(url).then(function (response) {
    ...
    subirarchivo2(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('vehiculos/subirarchivos',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
    ...
    guardarOrden(){
        ...
        axios.post('vehiculos/guardarOrden',{
            'id': me.tareas_id,
            'archivo': me.archivo
        }).then(function (response) {
    ...
    listarArchivos (id){
        console.log(id)
        let me=this;
        var url= 'vehiculos/archivos?page=1' + '&buscar='+ id;
        axios.get(url).then(function (response) {
    ...
    cambiarPagina2(page,buscar,criterio){
        ...
        //Envia la petición para visualizar la data de esa página
        me.listarPersona2(page,buscar,criterio,criterio);
    },
    agregarTarea(){
        let me = this;
        me.modalTarea=2;
    ...
    actualizarTecnico(){
        ...
        axios.put('vehiculostareas/actualizar',{
            'id': this.id,
            ...
            me.$toastr.success('Se actualizo el vehiculo', 'Vehiculos');
        }).catch(function (error) {
            console.log(error);
        });
    },
    ...
    axios.post('vehiculostareas/registrar',{
        'economico': this.economico,
        'odometro_entrada': this.odometro_entrada,
        'odometro_salida': this.odometro_salida,
        'placas': this.placas,
        ...
        me.cerrarModalTecnico();
        me.listarPersona(1,'','nombre');
        me.$toastr.success('Nuevo Vehiculo agregado', 'Vehiculos');
    }).catch(function (error) {
        console.log(error);
    });
},
    ...
    actualizarPersona(){
        ...
        axios.put('vehiculos/reparaciones/actualizar',{
            'id': this.tareas_id,
...
this.modal3=0;
    ...
    verOrden(){
        let me=this;
        var url= 'vehiculos/verOrden?id=' + me.tareas_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
    ...
    abrirModal(vehiculo){
        ...
        this.id = vehiculo.id;
        this.tipoAccion = 2;
        this.economico = vehiculo.economico;
        this.odometro_entrada = vehiculo.odometro_entrada;
        this.odometro_salida = vehiculo.odometro_salida;
        this.placas = vehiculo.placas;
        this.serie = vehiculo.serie;
        this.cliente = vehiculo.cliente;
        
    },
    trasportistas(persona){
        this.listarPersona2(1,persona.id,'','');
        this.modalTarea = 1;
        this.user_id = id;
    ...
    deleteTecnico(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.put('vehiculostareas/delete',{
                'id': id
            }).then(function (response) {
                me.listarPersona(1,'','','');
                swal(
    ...
    deleteReparacion(id){
       swal({
        ...
        if (result.value) {
            ...
            axios.put('vehiculos/reparaciones/delete',{
                'id': id
            }).then(function (response) {
                me.listarPersona2(1,me.user_id,'','');
                swal(
