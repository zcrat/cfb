    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Presupuestos Akumas 2024
...
methods : {
    ...
    reporte(id){
     ...
     verReporteAnomalias(){
        let me=this;
        var url= 'ordenesNew/verReporteAnomalias?id=' + me.presupuestoCFE_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
     ...
     verFotosNuevas(){
        let me=this;
        var url= 'ordenesNew/verFotosNuevas?id=' + me.presupuestoCFE_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
    ...
    verFotosInstaladas(){
        let me=this;
        var url= 'ordenesNew/verFotosInstaladas?id=' + me.presupuestoCFE_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
     ...
     verAcuse(){
        let me=this;
        var url= 'ordenesNew/verAcuse?id=' + me.presupuestoCFE_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
     ...
     verFacturaXML(){
        let me=this;
        var url= 'ordenesNew/verFacturaXML?id=' + me.presupuestoCFE_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
    ...
    verFacturaPDF(){
        let me=this;
        var url= 'ordenesNew/verFacturaPDF?id=' + me.presupuestoCFE_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
    ...
    listarIngreso (page,buscar,criterio, contra, fecha_inicio,fecha_final){
        ...
        let me=this;
        var url= 'ordenesNew?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final + '&eco_id=0'; 
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
     ...
     verFotosViejas(){
        let me=this;
        var url= 'ordenesNew/verFotosViejas?id=' + me.presupuestoCFE_id;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta = response.data;
     ...
     subirarchivo(e){
        ...
        fileReader.readAsDataURL(e.target.files[0])
        fileReader.onload = (e) => {
              axios.post('ordenesNew/subirarchivos',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
    ...
    subirarchivo2(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('ordenesNew/subirarchivos2',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
            if (response.data == "nada.doc"){
    ...
    subirarchivo3(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('ordenesNew/subirarchivos3',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
            if (response.data == "nada.doc"){
    ...
    subirarchivo4(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('ordenesNew/subirarchivos4',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
            if (response.data == "nada.doc"){
    ...
    subirarchivo5(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('ordenesNew/subirarchivos5',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
            if (response.data == "nada.doc"){
    ...
    subirarchivo6(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('ordenesNew/subirarchivos6',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
            if (response.data == "nada.doc"){
    ...
    subirarchivo7(e){
        ...
        fileReader.onload = (e) => {
            ...
            axios.post('ordenesNew/subirarchivos7',{
                'doc': e.target.result
            }).then(function (response) {
            console.log(response.data);
            if (response.data == "nada.doc"){
    ...
    listarTipos (){
        let me=this;
        var url= 'ordenesNew/selectTipos';
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
            me.arrayTipos = respuesta.tipos;
   ...
   llenado (p){
    ...
    borrarConcepto(detalle){
        ...
        axios.post('conceptos2023/delete',{
            'id': detalle.id,
    ...
    guardarFotosviejas(){
        ...
        axios.post('ordenesNew/guardarFotoVieja',{
    ...
    guardarReporteAnomalias(){
        ...
        axios.post('ordenesNew/guardarReporteAnomalias',{
            'id': me.presupuestoCFE_id,
            'archivo': me.archivo
        }).then(function (response) {
    ...
    guardarFotosNuevas(){
        ...
        axios.post('ordenesNew/guardarFotoNueva',{
            'id': me.presupuestoCFE_id,
            'archivo': me.archivo
        }).then(function (response) {
    ...
    guardarFotosInstaladas(){
        ...
        axios.post('ordenesNew/guardarFotoInstalada',{
            'id': me.presupuestoCFE_id,
            'archivo': me.archivo
        }).then(function (response) {
    ...
    guardarAcuse(){
        ...
        axios.post('ordenesNew/guardarAcuse',{
            'id': me.presupuestoCFE_id,
            'archivo': me.archivo
        }).then(function (response) {
    ...
    guardarFacturaXML(){
        ...
        axios.post('ordenesNew/guardarFacturaXML',{
            'id': me.presupuestoCFE_id,
            'archivo': me.archivo
        }).then(function (response) {
    ...
    guardarFacturaPDF(){
        ...
        axios.post('ordenesNew/guardarFacturaPDF',{
            'id': me.presupuestoCFE_id,
            'archivo': me.archivo
        }).then(function (response) {
    ...
    pdfCotizacionAcuse(id){
        window.open('ordenesNew/pdfAcuse/'+ id,'_blank');
    },
    mostrarDetalle(){
        let me=this;
        me.listado=0;
