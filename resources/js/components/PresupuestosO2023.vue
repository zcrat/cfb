                        ...
                        <tbody>
                            <tr v-for="cotizacion in arrayCotizacion" :key="cotizacion.id">
                                <td>
                                     ...
                                     <select name="LeaveType" v-model="cambiom"  @change="onChange($event,cotizacion)" class="form-control">
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="tipo_servicio" class="form-control" v-model="area">
                             ...
                             <option value="Planeacion">Planeacion </option>
                              <option value="Suninistro basico">Suministro basico </option>
                               <option value="Seguridad Fisica">Suguridad Fisica </option>
...
methods : {
    ...
    buscarConceptops(page,buscar){
        let me=this;
        var url= 'conceptosO2023/selectConceptos?idc=' + page + '&idt='+ buscar;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
