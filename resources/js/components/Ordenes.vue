                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <input type="text" v-model="buscar" @keyup.enter="listarIngreso(1,buscar,criterio,fecha_inicio,fecha_final)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listarIngreso(1,buscar,criterio,fecha_inicio,fecha_final)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="input-group">
                                    ...
                                    <tr v-for="cotizacion in arrayCotizacion" :key="cotizacion.id">
                                        <td>
                                             ...
                                             <select name="LeaveType" @change="onChange($event,cotizacion)" class="form-control">
                                                ...
                                                <option value="6">Presupeusto Acuse</option>
                               ...
                               <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" v-model="area" >
                                            <option v-for="plantel in arrayAreas" :key="plantel.id" :value="plantel.nombre" v-text="plantel.nombre"></option>
                                    </select>
                        
                                </div>
                                <div class="col-12 mt-2 text-center">
                                                        <button class="col- btn btn-primary"
                                                                @click="vistaAreasRegistrar"><i
                                                                class="fa fa-plus-circle"></i>
                                                        </button>
                                                    </div>
                            </div>
                             ...
                             <div class="col-md-3">
                                <div class="form-group">
                                   <div>
                                    ...
                                    <multiselect v-model="value" tag-placeholder="Add this as new tag" placeholder="Search or add a tag" label="titulo" track-by="id" :options="arrayCategorias" :multiple="true" :taggable="true" @tag="addTag"></multiselect>
                                    ...
                                    <div class="row" v-if="registrarArea">
                                        <!--Formulario nueva empresa-->
                                        <div class="col-12 border">
                                            <div class="row">
                                                <div class="col-12">
                                                    <h5 class="border-bottom pt-2">Registrar nueva Area</h5>
                                                </div>
                                                ...
                                                <div class="col-12 text-right p-3">
                                                    <button class="btn btn-primary" @click="guardarArea"><i
                                                            class="fa fa-floppy-o mr-2"></i>Guardar
                                                    </button>
                                                    <button class="btn btn-secondary" @click="vistaAreasRegistrar"><i
                                                            class="fa fa-times mr-2"></i>Canclear
                                                    </button>
                                                </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
     ...
     <select class="form-control" v-model="tipos_id" >
        ...
        <button type="button" class="btn btn-primary" @click="buscarConceptops(categorias_id,tipos_id,'1')" >Buscar</button>
         ...
         <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayConceptos.length">
                                        <tr v-for="detalle in arrayConceptos" :key="detalle.id">
                                            ...
                                            <td><button type="button" class="btn btn-danger btn-sm" @click="borrarConcepto(detalle)" ><i class="icon-trash"></i></button></td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
     ...
     <div class="form-group row">
                    ...
                    <!-- Modal -->
   <div class="modal fade fade bd-example-modal-lg" id="exampleModalCenter2" :class="{'mostrar7' : modal15}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        methods : {
            ...
            listarAreas(){
                ...
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
                    me.arrayAreas = respuesta.ubicaciones;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            reporte(id){
             ...
             verReporteAnomalias(){
                let me=this;
                var url= 'ordenes/verReporteAnomalias?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            vistaAreasRegistrar() {
                this.registrarArea = !this.registrarArea;
                this.modeloArea = {};
            },
             verFotosNuevas(){
                let me=this;
                var url= 'ordenes/verFotosNuevas?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            verFotosInstaladas(){
                let me=this;
                var url= 'ordenes/verFotosInstaladas?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            validarProducto(){
                ...
                if (!this.arrayProducto.codigo_sat) this.errorMostrarMsjProducto.push("Escriba un codigo sat no puede estar vacio");
                if (!this.arrayProducto.unidad_sat) this.errorMostrarMsjProducto.push("Escriba un codigo de unidad sat no puede estar vacio");
                if (!this.arrayProducto.unidad) this.errorMostrarMsjProducto.push("Escriba una unidad sat no puede estar vacio");
             ...
             verAcuse(){
                let me=this;
                var url= 'ordenes/verAcuse?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             verEntrada(){
                let me=this;
                var url= 'ordenes/verEntrada?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             verFacturaXML(){
                let me=this;
                var url= 'ordenes/verFacturaXML?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            verFacturaPDF(){
                let me=this;
                var url= 'ordenes/verFacturaPDF?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            listarIngreso (page,buscar,criterio,fecha_inicio,fecha_final){
                let me=this;
                var url= 'ordenes?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
             ...
             verFotosViejas(){
                let me=this;
                var url= 'ordenes/verFotosViejas?id=' + me.presupuestoCFE_id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             subirarchivo(e){
                ...
                fileReader.readAsDataURL(e.target.files[0])
                fileReader.onload = (e) => {
                      axios.post('ordenes/subirarchivos',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
            ...
            subirarchivo2(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes/subirarchivos2',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo3(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes/subirarchivos3',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo4(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes/subirarchivos4',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo5(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes/subirarchivos5',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo6(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes/subirarchivos6',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            subirarchivo7(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes/subirarchivos7',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
             ...
             subirarchivo9(e){
                ...
                fileReader.onload = (e) => {
                    ...
                    axios.post('ordenes/subirarchivos9',{
                        'doc': e.target.result
                    }).then(function (response) {
                    console.log(response.data);
                    if (response.data == "nada.doc"){
            ...
            listarCategorias (){
                let me=this;
                var url= 'ordenes/selectCategorias';
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
                    me.arrayCategorias = respuesta.categorias;
            ...
            buscarConceptops(page,buscar,page1){
                let me=this;
                var url= 'conceptos/selectConceptos?page=' + page1 + '&idc=' + page + '&idt='+ buscar;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
            ...
            cambiarPagina2(page,buscar,criterio){
                ...
                me.pagination.current_page = page;
                //Envia la petición para visualizar la data de esa página
                me.buscarConceptops(buscar,criterio,page);
            },
            encuentra(id){
                var sw=0;
            ...
            guardarFotosviejas(){
                ...
                axios.post('ordenes/guardarFotoVieja',{
            ...
            guardarReporteAnomalias(){
                ...
                axios.post('ordenes/guardarReporteAnomalias',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarFotosNuevas(){
                ...
                axios.post('ordenes/guardarFotoNueva',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarFotosInstaladas(){
                ...
                axios.post('ordenes/guardarFotoInstalada',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarAcuse(){
                ...
                axios.post('ordenes/guardarAcuse',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
             ...
             guardarEntrada(){
                ...
                axios.post('ordenes/guardarEntrada',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarFacturaXML(){
                ...
                axios.post('ordenes/guardarFacturaXML',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarFacturaPDF(){
                ...
                axios.post('ordenes/guardarFacturaPDF',{
                    'id': me.presupuestoCFE_id,
                    'archivo': me.archivo
                }).then(function (response) {
            ...
            guardarArea(){
                ...
                axios.post('areas/registrar',{
                    'nombre': me.modeloArea.nombre,

                }).then(function (response) {
                    
                    console.log(response.data);
                    me.listarAreas();
                    me.$toastr.success('Nueva area registrada', 'Areas');
                    me.registrarArea = false;
            ...
            agregarConcepto(array){
                ...
                axios.post('conceptos/registrar',{
