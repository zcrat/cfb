    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Talleres Externos CFE ECO
...
methods : {
    ...
    listarIngreso (page,buscar,criterio,fecha_inicio,fecha_final){
        ...
        let me=this;
        var url= 'ordenesCFEECO?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    listarTipos (){
        let me=this;
        var url= 'ordenesCFEECO/selectTipos';
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
            me.arrayTipos = respuesta.tipos;
