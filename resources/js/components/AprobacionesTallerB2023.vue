...
methods : {
    ...
    listarIngreso (page,buscar,criterio, contra, fecha_inicio,fecha_final){
        ...
        let me=this;
        var url= 'ordenesAllB2023?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    selectProducto(search,loading){
     ...
     verexel(page,buscar,criterio, contra, fecha_inicio,fecha_final){
        let me=this;
        window.open('ordenesB2023/exel?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final,'_blank');
    },
