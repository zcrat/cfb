      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <i class="fa fa-align-justify mr-2"></i> Hoja de Conceptos Akumas
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      guardarOrdenCompra(){
                let me = this;
                axios
                    .post('ordenCompra4',{datos:me.ordenCompra,conceptos:me.conceptosarray})
                    .then(function(response){
                        console.log(response.data);
                        me.$toastr.success('Se guardo correctamente la orden de compra', 'Orden de compra');
                        me.registrarRecepcion = 2;
    ...
    llenado (p){
      ...
      conceptos(ordenSeguimiento){
        ...
        let me = this;
        axios
          .get('conceptos4/'+ordenSeguimiento)
          .then(function(response){
            console.log(response);
    ...
    axios.post('conceptos2/registrar',{
      ...
      getConceptos(id){
        ...
        let me = this;
        axios
          .get("articulo/partes/get4?id="+id)
          .then(function(response){
            console.log(response);
      ...
      listarHojaConcepto() {
        let me = this;
        axios
          .get("hojaConceptos/index?modulo=4")
          .then(function(response) {
            console.log(response);
      ...
      buscarConceptops(pagina,page,buscar){
        let me=this;
        var url= 'conceptos2/selectConceptos?page=' + pagina +'&idc=' + page + '&idt='+ buscar;
        axios.get(url).then(function (response) {
            console.log(response.data);
            var respuesta= response.data;
    ...
    guardarTipo(){
      ...
      reporte(id) {
        window.open("hojaConcepto4/reporte/" + id, "_blank");
      },
