<template>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                 ...
                 <button class="btn btn-warning btn_sm float-right" type="button" @click="listarIngreso ('0','0','presupuestos.status','','')">
    ...
    export default {
        ...
        methods : {
            ...
            pdfdescargar(cotizacion){
                  let me=this;
                var url= 'ordenes2/factura?id='+cotizacion.id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
             ...
             verexel(page,buscar,criterio, contra, fecha_inicio,fecha_final){
                let me=this;
                window.open('ordenes2/exel?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&contra='+ contra + '&fecha_inicio='+ fecha_inicio + '&fecha_final='+ fecha_final,'_blank');
            },
        ...
        .catch(function (error) {
            ...
            verReporteAnomalias(id){
                let me=this;
                var url= 'ordenes2/verReporteAnomalias?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             verFotosNuevas(id){
                let me=this;
                var url= 'ordenes2/verFotosNuevas?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            verFotosInstaladas(id){
                let me=this;
                var url= 'ordenes2/verFotosInstaladas?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             verAcuse(id){
                let me=this;
                var url= 'ordenes2/verAcuse?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
             ...
             verFacturaXML(id){
                let me=this;
                var url= 'ordenes2/verFacturaXML?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            verFacturaPDF(id){
                let me=this;
                var url= 'ordenes2/verFacturaPDF?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
              ...
              verFotosViejas(id){
                let me=this;
                var url= 'ordenes2/verFotosViejas?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
           ...
           verOrdenServicio(id){
                let me=this;
                var url= 'ordenes2/verOrdenServicio?id=' + id;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta = response.data;
            ...
            facturando(cotizacion){
             ...
             timbrar(){
                ...
                axios.post('facturacion/timbrar2',
                   {
                    'factura' : me.factura,   
            ...
            pdfCotizacionp(id){
                window.open('ordenes2/pdfCFE/'+ id,'_blank');
            },
            mostrarDetalle(){
                let me=this;
                me.listado=0;
            ...
            actualizarcarrito(detalle){
             let me = this;
                ...
                axios.post('detalleconceptos2/actualizar',{
                    'id': detalle.id,
                    'cantidad': detalle.cantidad,
