            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Productos por Grupos
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idcategoria">
                                            ...
                                            <option v-for="categoria in arrayCategoria" :key="categoria.id" :value="categoria.id" v-text="categoria.strdescripcion"></option>
                                        </select>                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idgrupo">
                                            <option value="0" disabled>Seleccione</option>
                                            <option v-for="grupo in arrayGrupos" :key="grupo.id" :value="grupo.id" v-text="grupo.nombre"></option>
                                        </select>                                        
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Precio Grupo</label>
                                    <div class="col-md-9">
    ...
    export default {
        ...
        methods : {
            ...
            listarArticulo (page,buscar,criterio){
                let me=this;
                var url= 'productosgrupos?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    console.log(response.data);
                    var respuesta= response.data;
            ...
            selectCategoria(){
                let me=this;
                var url= 'productos/selectProductos';
                axios.get(url).then(function (response) {
                    //console.log(response);
                    var respuesta= response.data;
                    me.arrayCategoria = respuesta.productos;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            registrarArticulo(){
                ...
                axios.post('productosgrupos/registrar',{
                    'productos_id': this.idcategoria,
                    'grupos_id': this.idgrupo,
            ...
            validarArticulo(){
                ...
                if (this.idcategoria==0) this.errorMostrarMsjArticulo.push("Seleccione un producto.");
                if (this.idgrupo==0) this.errorMostrarMsjArticulo.push("Seleccione un grupo");
                ...
                switch(modelo){
                    case "articulo":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Agregar precio a grupo';
                                this.idcategoria=0;
                                this.nombre_categoria='';
                                this.codigo_sat='';
                                this.unidad_sat='';
                            ...
                            case 'actualizar':
                            {
                                //console.log(data);
                                this.modal=1;
                                this.tituloModal='Editar precio de grupo';
                                this.tipoAccion=2;
                                this.articulo_id=data['id'];
                                this.idcategoria=data['idcategoria'];
                                this.idgrupo=data['grupos_id'];
