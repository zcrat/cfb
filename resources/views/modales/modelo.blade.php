            ...
            <div class="modal-body">
                <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                    <div class="select2conlabel zdw-40pct">
                        ...
                        <select class="marcasvehiculo-Select2" id="marcanewmodelo"name="marcanewmodelo"
                            required></select>
                    ...
                    <div class=" selectconlabel zdmg-r02">
                        ...
                        <input required class="form-control" type="text" placeholder="Ej.Tacoma" id="newmodelo"
                            name="newmodelo">
                    </div>
                </div>
            </div>
