                ...
                <div class="modal-body">
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                        ...
                        <div class=" selectconlabel zdmg-r02">
                            ...
                            <input required class="form-control" type="number" id="rsKm_De_Ingreso"
                                name="rsKm_De_Ingreso">
                        </div>
                        <div class=" selectconlabel zdmg-r02">
                            <label for="rsAdministrador_de_Transportes">Administrador de
                                Transportes<strong>*</strong></label>
                            <input required class="form-control" type="text" id="rsAdministrador_de_Transportes"
                                name="rsAdministrador_de_Transportes">
                        </div>
                        <div class=" selectconlabel zdmg-r02">
                            <label for="rsJefe_de_Proceso">Jefe de Proceso<strong>*</strong></label>
                            <input required class="form-control" type="text" id="rsJefe_de_Proceso"
                                name="rsJefe_de_Proceso">
                        </div>
                        <div class=" selectconlabel zdmg-r02">
                        ...
                        <div class=" selectconlabel zdmg-r02">
                            ...
                            <input required class="form-control" type="text" id="rsTrabajador"
                                name="rsTrabajador">
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w" id="serviciopreventivo" hidden>
                        ...
                        <div class="selectconlabel">
                            ...
                            <input class="form-control" type="number"id="rsKilometraje2"
                                name="rsKilometraje2"></input>
                        </div>
                    </div>
    ...
    <script>
        $(function() {
            ...
            $("#serviciorecepcionform").submit(function(e) {
                ...
                let data = form.serialize() + '&modulo=' + @json($modulo) + '&empresa_id=' +
                    id_empresa + '&contrato=' + @json($contrato);
                modal.modal("hide");
