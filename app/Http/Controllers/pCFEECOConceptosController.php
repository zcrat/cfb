...
class pCFEECOConceptosController extends Controller
{
    public function index(Request $request){

        $categoria = pCFECategorias::where('CFE_id','=','6')->where('sucursal_id','=',\Auth::user()->sucursal_id)->orderBy('titulo', 'asc')->get();
