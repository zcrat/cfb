...
class pCFEB2023ConceptosController extends Controller
{
    public function index(Request $request){

        $categoria = pCFECategorias::where('CFE_id','=','1')->orderBy('titulo', 'asc')->get();
        $tipos = pCFETipos::where('CFE_id','=','1')->orderBy('tipo', 'asc')->get();
