...
class presupuestosCFEBajio2023Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        $categorias = pCFECategorias::where('CFE_id','=','2')->orderBy('titulo', 'asc')->get();
        $tipos = pCFETipos::where('CFE_id','=','2')->orderBy('tipo', 'asc')->get();
